...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2020 at 09:58 AM
...
(1, 1, '2020-04-20 21:13:45'),
(2, 1, '2020-04-20 21:14:48'),
(3, 1, '2020-04-20 21:15:50');
...
(1, 1, '978-1-1180-2669-4', 10),
(2, 1, '978-1-1180-2669-4', 14);
...
INSERT INTO `category` (`categoryid`, `category_name`, `Is_Active`) VALUES
(1, 'Fiction', 1),
(2, 'Children', 1),
(3, 'Education', 1),
(4, 'Health And Diet', NULL),
(5, 'Arts And Entertainments', NULL),
(6, 'Cooking,Food And Drink', NULL),
(9, 'Non-Fiction', NULL),
(10, 'Kelvin', 1),
(11, 'ddddddddddddd', 1);
...
INSERT INTO `customers` (`id`, `firstname`, `lastname`, `username`, `email`, `Is_Active`, `password`, `address`, `city`, `zipcode`, `phone`) VALUES
(1, 'Gift', 'Balogun', 'giftbalogun', 'blgn@gmail.com', 1, '25d55ad283aa400af464c76d713c07ad', 'Hanson Avenue', 'Port Harcourt', '112233', '08027237396');
...
INSERT INTO `publisher` (`publisherid`, `publisher_name`, `Is_Active`) VALUES
(2, 'Wiley', 1),
(7, 'OReilly Media', 1),
(8, 'Paper Back', 1),
(10, 'Bloomsbury Publishing PLC', 1),
(11, 'Wrox', 1),
(12, 'ff', 1);
