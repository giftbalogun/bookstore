...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query = mysqli_query($con, "update tblpages set PageTitle='$pagetitle', phone ='$phone', email='$email' where PageName='$pagetype' ");
        if ($query) {
            $msg = "Site Settings  page successfully updated ";
        } else {
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <?php
                            $pagetype = 'overal';
                            $query = mysqli_query($con, "select PageTitle,phone,email from tblpages where PageName='$pagetype'");
                                    ...
                                    <form name="overal" method="post">
                                        ...
                                        <div class="form-group m-b-20">
                                            ...
                                            <input type="number" class="form-control" id="phone" name="phone"
                                                value="<?php echo htmlentities($row['phone']) ?>" required>
                                        </div>
                                        <div class="form-group m-b-20">
