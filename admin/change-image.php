...
if (strlen($_SESSION['manager']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $postid = $_GET['pid'];
            $query = mysqli_query($conn, "update books set book_image='$imgnewfile' where id='$postid'");
            if ($query) {
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <form name="addpost" method="post" enctype="multipart/form-data">
                            <?php
                            $postid = $_GET['pid'];
                            $query = mysqli_query($conn, "select * from books where id='$postid' and Is_Active=1 ");
                                            ...
                                            <div class="">
                                                <form name="addpost" method="post">
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <input type="text" class="form-control" id="title" value="<?php echo htmlentities($row['book_title']); ?>" name="title" readonly>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="card-box">
