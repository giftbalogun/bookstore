                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="ordersplaced.php" class="waves-effect"><i class="mdi mdi-view-dashboard"></i>
                    ...
                    <div class="help-box">
                        <h5 class="text-muted m-t-0">For Help Message Me</h5>
                        <p class=""><span class="text-custom">Email:</span><br />balogunigift@gmail.com</p>
                    </div>
                </div>
                <!-- Sidebar -left -->
            </div>